...
export const loadResourceAdminPage = () => import("./pages/ResourceAdminPage");
...
export const SYSTEM_SECTIONS: Array<{ key: "overview" | "models" | "accounts" | "audit" | "settings" | "sso" | "resources"; label: string; icon: string }> = [
