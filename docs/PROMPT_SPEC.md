...
- 声轨纪律（2026-06-14 v13 改：保留剧本声音）：分镜必须从完整剧本保留角色对白、内心OS、旁白、人群嘲讽/恭维等可听见信息，不能把有声剧本压成纯画面卡。说明性旁白仍要少用，但必要内心OS、结尾悬念旁白、非角色圣经人物的人群声应放入 narration；预计 40/50/60s 集至少约 75% 镜头应有 dialogues 或 narration。
