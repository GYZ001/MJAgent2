...
- 原文结尾之后又生成了“戒指发光/丙老暗示”等内容，而集级钩子字段实际为空，属于系统为了满足钩子形式而主动补写剧情。
...
```json
{
  ...
  "source_fact": "测试员喊出甲一的名字，广场安静下来",
  "state_in": "人群仍在议论上一位测试者",
  "trigger": "测试员点名甲一",
  "visible_change": "人群停止议论并转向甲一",
  "state_out": "甲一成为所有人的视线焦点",
  "must_keep": true,
...
```json
{
  "shot_no": 11,
  "story_event_id": "E07",
  "purpose": "测试员点名，甲一成为焦点",
  "new_information_ids": ["I12"],
  "state_in": "广场仍有低声议论，甲一站在人群后方",
  "primary_action": "画外测试员点名后，人群安静并同时转头看向甲一",
  "emotion_beat": "嘈杂转为压迫性的安静",
  "state_out": "人群视线集中在仍站原地的甲一身上",
  ...
  "do_not_repeat": ["甲三测试结果", "再次点名甲一", "甲一已经走向石碑"],
...
> 测试员叫到甲一，人群安静；甲一从人群中走出并自我介绍，走到石碑前，袖口滑落，伸手触摸石碑。
...
|---|---:|---|---|---|---|---|
| A | 5 秒 | 测试员点名甲一 | 人群由议论转为安静并看向甲一 | 画外测试员：“下一个，甲一。” | 甲一仍站在人群中，成为视线焦点 | `reaction_cut` |
| B | 5 秒 | 甲一接受测试 | 甲一从人群中走出，在通道口站定 | 脚步声、低环境声；无台词 | 甲一已离开人群，正面朝向石碑 | `same_scene_cut` |
| C | 5 秒 | 甲一开始测试 | 甲一走完最后两步，将右手平稳贴上石碑 | 环境声；可有短促呼吸声 | 右掌已经贴住石碑，石碑尚未显示结果 | `action_continuation` 或独立侧面切镜，依具体构图决定 |
| D | 5 秒 | 测试结果 | 石碑从暗到亮，稳定显示指定结果 | 低沉能量声；必要时画外测试员读出结果 | 文字稳定可读，甲一的手仍贴在石碑上 | `insert_detail` |
...
[REFERENCE ROLES]
参考图 A 只用于甲一的脸、发型和黑色服装身份；参考图 B 只用于斗气测试广场的石质建筑、日间光线和色调。重新建立当前中远景构图，不复制参考图中的姿势或额外人物。

[START STATE | 0.0s]
斗气测试广场上，人群正在低声议论。甲一站在人群后方，身体静止，尚未迈步，周围人的视线分散。

[ONE CURRENT ACTION]
画外测试员点名后，议论声立刻停止，周围人依次转头看向甲一；甲一只轻微抬眼，不走出人群。只完成这一个由嘈杂转为全场注视的变化，不再次介绍前一位测试者，也不让甲一提前走向石碑。

[END STATE | 5.0s]
人群已经安静并把视线集中在甲一身上；甲一仍站在原位，表情克制，石碑没有发光。

[CAMERA]
中远景，略低机位，从人群肩部间缓慢推近甲一。保持甲一在人群后方中央，测试石碑位于远处画面右侧。

[AUDIO TIMELINE]
0.0–0.3 秒：低声人群议论和广场风声。
0.3–1.8 秒：测试员在画外用成年男性中低音、平稳公事公办的普通话说：“下一个，甲一。”测试员不在画面中，不做口型。
...
[CONSISTENCY]
甲一保持少年男性、清瘦脸型、黑发和黑色服装；广场材质、天气和光向与场景参考一致。

[DO NOT]
不要重复点名；不要让甲一行走、触碰石碑或说话；石碑不要发光；不要出现前一位测试结果；不要复制甲一；不要出现镜头内测试员；不要生成字幕、乱码或水印。
```
