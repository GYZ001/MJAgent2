...
第一千六百二十二章对决之战
角色丙踏着黑云现身，角色甲迎空而起。两人气息碰撞，中域众人抬头仰望。
角色丙冷声宣战，角色甲催动烈焰回应，对决之战由此爆发。
黑云与烈焰反复撞击，角色乙和角色丁率领联盟众人后撤，守住最后一道防线。
角色甲踏焰逼近角色丙，两位强者连续交锋，余波掀翻山岭，也让所有人看清决战已经无法回避。
角色丙再次催动黑潮，角色甲则召回漫天烈焰，在众人的注视下凝成足以决定天地命运的火焰之阵。

第一千六百二十三章 对决之战！（下）
烈焰在天空汇聚成阵，战斗继续向最后的决胜推进。
"""
    ...
    assert "角色丙踏着黑云现身" in result["chapters"][0]["content"]
