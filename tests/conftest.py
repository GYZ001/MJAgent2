...
from tests.patch_targets import patch_auth_everywhere as patch_auth_everywhere, patch_authz_everywhere as patch_authz_everywhere, patch_models_registry_everywhere as patch_models_registry_everywhere, patch_orgs_everywhere as patch_orgs_everywhere, patch_provisioning_everywhere as patch_provisioning_everywhere, patch_sso_everywhere as patch_sso_everywhere  # 搬家：行数基线
