...
def ensure_production_revisions_table(conn=None) -> None:
    ...
    authority_version.ensure_table_with_triggers(db, "production_revisions", """CREATE TABLE IF NOT EXISTS production_revisions (
...
_register_table("production_revisions_table", ensure_production_revisions_table)
