...
IDENTITY_GENERATION_RULES = [
    ...
    "required_dialogue 的 speaker_identity_id、excluded_speaker_identity_ids、delivery_kind、quote_id 和来源偏移是原文证据：明确归属须保持，听者不能充当发声者。没有明确归属时使用有证据的无名人物，并填写 attribution_evidence；旁白只用于原文叙述者发声。source_quote_id 引用对应 quote_id。",
