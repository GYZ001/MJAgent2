...
CHANNEL_DEFAULTS: dict[str, int] = {
    S.RESOURCE_REFERENCE: 6,
    S.RESOURCE_IMAGE: 4,
    S.RESOURCE_VLM: 6,
    S.RESOURCE_VIDEO_SUBMIT: 4,
    S.RESOURCE_VIDEO_INFLIGHT: 8,
    S.RESOURCE_VIDEO_POLL: 8,
...
class WorkerPool:
    """可升降的 asyncio worker 池。缩容时取消多余空闲任务。"""

    def __init__(self, name: str, worker_coro_factory):
        self.name = name
        self._factory = worker_coro_factory
